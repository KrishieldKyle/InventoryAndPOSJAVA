 ...
 * @author Justine
 */
public class Details4 extends JFrame implements ActionListener
{
    JButton del = new JButton("                                                                 ASK FOR STOCK                                                                      ");
    Details4()
    {
        setSize(540,390);
        setTitle("DISCRETE STRUCTURE");  
        setResizable(false);
        setVisible(true);
        ...
        JLabel lbl1 = new JLabel(" FUNDAMENTAL CONCEPTS OF");
        JLabel lbl9 = new JLabel(" MATHEMATICAL STRUCTURES");
        JLabel lbl2 = new JLabel(" PRICE - P220");
        JLabel lbl3 = new JLabel("          ");
        JLabel lbl4 = new JLabel(" By:");
        JLabel lbl5 = new JLabel("  Paulino P. Malang, MA");
        JLabel lbl6 = new JLabel("  Bernrdino P. Malang, MSIT");
        JLabel lbl7 = new JLabel("  Irish R. Tiongson, BSM");
        JLabel lbl8 = new JLabel("  Dolores G. Barcelon, PhD");
        ...
        */
        ...
        JLabel backgroundimg=new JLabel(new ImageIcon("C:\\Users\\justine\\Desktop\\logos\\Discrete.png"));
     ...
     public void actionPerformed(ActionEvent e)
    {
        if(e.getSource().equals(del))
        {
            ...
            PROJECT_SWING.bookCtr[3]=10;
            PROJECT_SWING.quantity[3].setText(PROJECT_SWING.bookCtr[3]+"");
        }
    }
    public static void main(String[] args) 
    {
        Details4 D4= new Details4();
