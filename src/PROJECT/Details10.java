 ...
 * @author Justine
 */
public class Details10 extends JFrame implements ActionListener
{
    JButton del = new JButton("                                                                 ASK FOR STOCK                                                                      ");
    Details10()
    {
        setSize(540,390);
        setTitle("MULTIMEDIA AND WEB DESIGN");  
        setResizable(false);
        setVisible(true);
        ...
        JLabel lbl1 = new JLabel(" MULTIMEDIA AND WEB DESIGN");
        JLabel lbl8 = new JLabel(" AND DEVELOPMENT         ");
        JLabel lbl2 = new JLabel(" PRICE - P220");
        JLabel lbl3 = new JLabel("          ");
        JLabel lbl4 = new JLabel(" By:");
        JLabel lbl5 = new JLabel("  Theodor Richardson");
        JLabel lbl6 = new JLabel("  Charles Thies");
        ...
        */
        ...
        JLabel backgroundimg=new JLabel(new ImageIcon("C:\\Users\\justine\\Desktop\\logos\\Medibols.png"));
    ...
    {
        Details10 D10= new Details10();
        D10.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    }
