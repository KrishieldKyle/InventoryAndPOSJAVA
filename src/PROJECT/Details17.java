 ...
 * @author Justine
 */
public class Details17 extends JFrame implements ActionListener
{
    JButton del = new JButton("                                                                ASK FOR STOCK                                                                      ");
    Details17()
    {
        setSize(540,390);
        setTitle("WEB APPLICATION DEVELOPMENT");  
        setResizable(false);
        setVisible(true);
        ...
        JLabel lbl1 = new JLabel(" HTML5 WEB APPLICATION");
        JLabel lbl9 = new JLabel(" DEVELOPMENT BY EXAMPLE");
        JLabel lbl2 = new JLabel(" PRICE - P220");
        JLabel lbl3 = new JLabel("          ");
        JLabel lbl4 = new JLabel(" By:");
        JLabel lbl5 = new JLabel("  J.M. Gustafson");
        ...
        */
        ...
        JLabel backgroundimg=new JLabel(new ImageIcon("C:\\Users\\justine\\Desktop\\logos\\html5.png"));
    ...
    {
        Details17 D17= new Details17();
        D17.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    }
