 ...
 * @author Justine
 */
public class Details15 extends JFrame implements ActionListener
{
    JButton del = new JButton("                                                                 ASK FOR STOCK                                                                      ");
    Details15()
    {
        setSize(540,390);
        setTitle("CODE OF ETHICS OF THE ITE PROFFESIONALS");  
        setResizable(false);
        setVisible(true);
        ...
        JLabel lbl1 = new JLabel(" Code of Ethics of the");
        JLabel lbl4 = new JLabel(" ITE Professionals");
    ...
    {
        Details15 D15= new Details15();
        D15.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    }
