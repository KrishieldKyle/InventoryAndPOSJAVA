 ...
 * @author Justine
 */
public class Details2 extends JFrame implements ActionListener
{
    JButton del = new JButton("                                                                   ASK FOR STOCK                                                                      ");
    Details2()
    {
        setSize(540,390);
        setTitle("FUNDAMENTALS OF PROGAMMING LANGUAGE");  
        setResizable(false);
        setVisible(true);
        ...
        JLabel lbl1 = new JLabel(" FUNDAMENTALS OF PROGRAMMING");
        JLabel lbl9 = new JLabel(" LANGUAGE (C++)");
        ...
        */
        ...
        JLabel backgroundimg=new JLabel(new ImageIcon("C:\\Users\\justine\\Desktop\\logos\\FundC++.png"));
    ...
    public void actionPerformed(ActionEvent e)
    {
        if(e.getSource().equals(del))
        {
            ...
            PROJECT_SWING.bookCtr[1]=10;
            PROJECT_SWING.quantity[1].setText(PROJECT_SWING.bookCtr[1]+"");
        }
    }
