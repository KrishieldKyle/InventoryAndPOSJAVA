 ...
 * @author Justine
 */
public class Details16 extends JFrame implements ActionListener
{
    JButton del = new JButton("                                                                  ASK FOR STOCK                                                                      ");
    Details16()
    {
        setSize(540,390);
        setTitle("OPERATING SYSTEM PRINCIPLE AND APPLICATION");  
        setResizable(false);
        setVisible(true);
        ...
        JLabel lbl1 = new JLabel(" PRINCIPLES OF");
        JLabel lbl9 = new JLabel(" OPERATING SYSTEM");
        JLabel lbl2 = new JLabel(" PRICE - P220");
        JLabel lbl3 = new JLabel("          ");
        JLabel lbl4 = new JLabel(" By:");
        JLabel lbl5 = new JLabel("  Nauresh Chauhan");
        ...
        */
        ...
        JLabel backgroundimg=new JLabel(new ImageIcon("C:\\Users\\justine\\Desktop\\logos\\OP.png"));
    ...
    {
        Details16 D16= new Details16();
        D16.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    }
