 ...
 * @author Justine
 */
public class Details11 extends JFrame implements ActionListener
{
    JButton del = new JButton("                                                                  ASK FOR STOCK                                                                      ");
    Details11()
    {
        setSize(540,390);
        setTitle("COMPUTER SYSTEM ORGANIZATION");  
        setResizable(false);
        setVisible(true);
        ...
        JLabel lbl1 = new JLabel(" COMPUTER SYSTEM ORGANIZATION");
        JLabel lbl2 = new JLabel(" PRICE - P220");
        JLabel lbl3 = new JLabel("          ");
        JLabel lbl4 = new JLabel(" By:");
        JLabel lbl5 = new JLabel("  Engr. Lester Phil M. Cruz");
        JLabel lbl6 = new JLabel("  Engr. Enrique M. Ravana");
        JLabel lbl7 = new JLabel("  Engr. Evelyn C. Samson");
        ...
        */
        ...
        JLabel backgroundimg=new JLabel(new ImageIcon("C:\\Users\\justine\\Desktop\\logos\\Marissa.png"));
    ...
    {
        Details11 D11= new Details11();
        D11.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    }
