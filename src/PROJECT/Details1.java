...
public class Details1 extends JFrame implements ActionListener
{
    ...
    Details1()
    {
        ...
        JLabel lbl1 = new JLabel(" FUNDAMENTALS OF ICT");
        JLabel lbl2 = new JLabel(" PRICE - P220");
        JLabel lbl3 = new JLabel("          ");
        JLabel lbl4 = new JLabel(" By:");
        JLabel lbl5 = new JLabel("  Raquel C. Adriano");
        JLabel lbl6 = new JLabel("  Josephine R. Bayonito");
        JLabel lbl7 = new JLabel("  Marian Minneli S. Cruz");
        JLabel lbl8 = new JLabel("  Melanie M. Orbeso");
        ...
        */
        ...
        JLabel backgroundimg=new JLabel(new ImageIcon("C:\\Users\\justine\\Desktop\\logos\\ICTFund.png"));
    ...
    public void actionPerformed(ActionEvent e)
    {
        if(e.getSource().equals(del))
        {
            ...
            PROJECT_SWING.bookCtr[0]=10;
            PROJECT_SWING.quantity[0].setText(PROJECT_SWING.bookCtr[0]+"");
        }
    }
